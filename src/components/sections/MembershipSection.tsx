      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center w-full">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="bg-orange-100 p-6 md:p-8 lg:p-12 relative overflow-hidden">
              <div className="relative z-10">
                <div className="text-xs md:text-sm text-gray-500 uppercase mb-2">6 MONTHS ONLY</div>
            ...
            <div className="bg-orange-300 p-6 md:p-8 lg:p-12 relative overflow-hidden">
              <div className="relative z-10">
                <div className="text-xs md:text-sm text-gray-500 uppercase mb-2">VB SUBSCRIPTION</div>
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-black mb-3 md:mb-4">
                  프리미엄 구독 고객 전용
                </h3>
                <p className="text-sm md:text-base text-gray-700 mb-4 md:mb-6 leading-relaxed">
