  ...
  const products = [
    {
      ...
      hashtags: '#엔젤링 #머릿결',
      url: 'https://smartstore.naver.com/vbcos/products/12664148711',
    },
    {
      id: 2,
      ...
      name: '빌라드블랑 시그니처 샴푸',
      hashtags: '#탈모 #비듬제거',
      url: 'https://smartstore.naver.com/vbcos/products/5535722839',
    },
    {
      id: 3,
      ...
      name: '빌라드블랑 샴푸 브러쉬',
      hashtags: '#두피건강 #모근강화',
      url: 'https://smartstore.naver.com/vbcos/products/6055996500',
    },
  ];
